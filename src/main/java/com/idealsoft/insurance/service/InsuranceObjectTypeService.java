...
public class InsuranceObjectTypeService {
    ...
    public Optional<InsuranceObjectTypeDTO> findByCode(String objectType) {
        return insuranceObjectTypeRepository.findByCode(objectType).map(insuranceObjectTypeMapper::toDto);
    }
}
