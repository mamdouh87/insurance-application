...
public class InsuranceInstanceResourceIT {
    ...
    @Autowired
    private InsuranceInstanceService insuranceInstanceService;
    ...
    public void createInsuranceInstance() throws Exception {
        ...
        InsuranceInstanceDTO insuranceInstanceDTO = insuranceInstanceMapper.toDto(insuranceInstance);
        restInsuranceInstanceMockMvc.perform(post("/api/insurance-instances")
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(insuranceInstanceDTO)))
    ...
    public void updateInsuranceInstance() throws Exception {
        ...
        updatedInsuranceInstance
            .instanceDate(UPDATED_INSTANCE_DATE);
        InsuranceInstanceDTO insuranceInstanceDTO = insuranceInstanceMapper.toDto(updatedInsuranceInstance);
